...
# Set the message variable equal to any string containing a
...
# Set the quotation variable to any string that contains an escaped
...
# Though Udemy's platform doesn't support f-string yet,
# I think it's a much nicer syntax:
